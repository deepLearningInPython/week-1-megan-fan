...
def ReLu(array, cutoff = 0):
    ...
    return n_array
#np.maximum will compare each element in the array to the scalar and return a new array where 
#each element is the maximum of the original element and the scalar.
# -----------------------------------------------
